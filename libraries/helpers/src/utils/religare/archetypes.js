...
exports.ARCHETYPE_QUESTIONS = exports.ARCHETYPE_INFO = void 0;
exports.scoreArchetypes = scoreArchetypes;
exports.ARCHETYPE_INFO = {
    innocent: {
        key: 'innocent',
        name: 'Inocente',
        tagline: 'Fé e otimismo',
        description: 'Busca a felicidade e a simplicidade. Acredita no bem e inspira esperança e leveza.',
    },
    sage: {
        key: 'sage',
        name: 'Sábio',
        tagline: 'Verdade e compreensão',
        description: 'Move-se pela busca do conhecimento e da verdade. Analisa, ensina e oferece clareza.',
    },
    explorer: {
        key: 'explorer',
        name: 'Explorador',
        tagline: 'Liberdade e descoberta',
        description: 'Anseia por autenticidade e novos horizontes. Foge do tédio e abre caminhos.',
    },
    outlaw: {
        key: 'outlaw',
        name: 'Rebelde',
        tagline: 'Ruptura e revolução',
        description: 'Questiona o status quo e quebra o que não serve mais. Transforma pela disrupção.',
    },
    magician: {
        key: 'magician',
        name: 'Mago',
        tagline: 'Transformação e visão',
        description: 'Conecta mundos e realiza o que parece impossível. Catalisa mudança e significado.',
    },
    hero: {
        key: 'hero',
        name: 'Herói',
        tagline: 'Coragem e maestria',
        description: 'Supera desafios com disciplina e força de vontade. Prova seu valor pela ação.',
    },
    lover: {
        key: 'lover',
        name: 'Amante',
        tagline: 'Conexão e beleza',
        description: 'Vive pela intimidade, sensualidade e paixão. Cria vínculos e celebra a beleza.',
    },
    jester: {
        key: 'jester',
        name: 'Bobo da Corte',
        tagline: 'Alegria e presença',
        description: 'Traz leveza e humor ao momento presente. Desarma pela espontaneidade.',
    },
    everyman: {
        key: 'everyman',
        name: 'Companheiro',
        tagline: 'Pertencimento e empatia',
        description: 'Valoriza a igualdade e a conexão genuína. Realista, acessível e solidário.',
    },
    caregiver: {
        key: 'caregiver',
        name: 'Cuidador',
        tagline: 'Serviço e compaixão',
        description: 'Protege e nutre os outros. Generoso, presente e atento às necessidades alheias.',
    },
    ruler: {
        key: 'ruler',
        name: 'Governante',
        tagline: 'Ordem e responsabilidade',
        description: 'Busca estabilidade e excelência. Lidera, organiza e cria estruturas duradouras.',
    },
    creator: {
        key: 'creator',
        name: 'Criador',
        tagline: 'Imaginação e expressão',
        description: 'Dá forma ao novo. Inventivo e expressivo, realiza visões em algo concreto.',
    },
};
exports.ARCHETYPE_QUESTIONS = [
    {
        id: 'a1',
