...
export const initializeSentryBasic = (environment, dsn, extension) => {
    if (!dsn) {
        return;
    }
    ...
    try {
        Sentry.init(Object.assign(Object.assign({ initialScope: {
                tags: {
                    service: 'frontend',
                    component: 'nextjs',
                    replaysEnabled: 'true',
            ...
            ], environment: environment || 'development', spotlight: process.env.SENTRY_SPOTLIGHT === '1', dsn, sendDefaultPii: true }, extension), { debug: environment === 'development', tracesSampleRate: 1.0, beforeSend(event, hint) {
...
//# sourceMappingURL=initialize.sentry.next.basic.js.map