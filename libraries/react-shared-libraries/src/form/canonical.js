...
export const Canonical = (props) => {
    var _a, _b, _c;
    const { label, date, className, disableForm, error, translationKey, translationParams } = props, rest = __rest(props, ["label", "date", "className", "disableForm", "error", "translationKey", "translationParams"]);
    ...
    const onPostSelector = useCallback(() => __awaiter(void 0, void 0, void 0, function* () {
        const id = yield postSelector();
        if (disableForm) {
            // @ts-ignore
