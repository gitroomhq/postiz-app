...
export const ColorPicker = (props) => {
    const { name, label, enabled, value, canBeCancelled, onChange, translationKey, translationParams, } = props;
    ...
    const enable = useCallback(() => __awaiter(void 0, void 0, void 0, function* () {
        yield color.onChange({
            target: {
                name,
                value: '#FFFFFF',
            },
    ...
    const cancel = useCallback(() => __awaiter(void 0, void 0, void 0, function* () {
        yield color.onChange({
            target: {
                name,
                value: '',
    ...
    return (<div className="flex flex-col gap-[6px]">
      ...
      <div className="flex items-end gap-[20px]">
        <div>
          <HexColorPicker color={watch} onChange={(value) => color.onChange({
            target: {
                name,
                value,
            },
        ...
        <div className="flex gap-[10px]">
          <div>
            <div className="w-[20px] h-[20px]" style={{
