  ...
  return (
    <div className="flex flex-col gap-[6px]">
      <div className="flex items-center gap-[3px]">
        ...
        <div>
          <svg
            ...
            className="cursor-pointer text-pqMuted hover:text-pqText"
      ...
      <input
        ...
        className={clsx(
          'h-[44px] rounded-[10px] border-0 bg-pqTableHeader px-[12px] text-[14px] text-pqText outline-none shadow-[inset_0_0_0_1px_var(--border)] transition-shadow placeholder:text-pqSoft focus:shadow-[inset_0_0_0_1px_var(--brand)]',
          className
        )}
        {...rest}
      />
