...
export const Total: FC<{
  ...
  return (
    <div className="flex flex-col gap-[6px] relative w-[158px]">
      <div className="text-[14px] text-pqMuted">{t('total', 'Total')}</div>
      <div
        className={clsx(
      ...
      >
        <div className="flex-1 px-[16px] text-[14px] select-none flex gap-[8px] items-center">
          <div
            ...
            className={clsx(
              'cursor-pointer',
              value === 1 ? 'text-pqSoft' : 'text-pqText'
            )}
          >
            <svg
          ...
          <div className="flex-1 text-pqText text-[14px] text-center">
            {value}
          </div>
          <div onClick={changeNumber(value + 1)} className="cursor-pointer text-pqText">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
              height="16"
