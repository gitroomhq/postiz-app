...
export const CustomSelect: FC<{
  ...
  return (
    <div className={clsx('flex flex-col gap-[6px] relative', className)}>
      ...
      <div
        className={clsx(
          'flex h-[44px] items-center justify-center rounded-[10px] bg-pqTableHeader text-pqText shadow-[inset_0_0_0_1px_var(--border)]'
        )}
        onClick={changeOpen}
      >
        ...
        <div className="pe-[16px] flex gap-[8px] text-pqSoft">
          <div>
            <svg
          ...
          {!!value && (
            <div onClick={setOption(undefined)} className="text-pqSoft hover:text-pqText">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
                height="16"
      ...
      {isOpen && (
        <div
          className={clsx(
            ...
            'z-[100] absolute w-full top-[100%] start-0 flex items-center rounded-b-[10px] flex-col bg-pqPop gap-[1px] border border-t-0 border-pqBorder overflow-hidden shadow-pqE2'
          )}
        >
          {options.map((option) => (
            <div
              ...
              className="px-[16px] py-[8px] bg-pqPop w-full flex gap-[8px] hover:bg-pqHover select-none cursor-pointer text-pqText"
            >
              {!!option.icon && (
                <div className="flex justify-center items-center">
                  {option.icon}
