...
let OpenaiService = class OpenaiService {
    generateImage(prompt_1, isUrl_1) {
        return __awaiter(this, arguments, void 0, function* (prompt, isUrl, isVertical = false) {
            const generate = (yield openai.images.generate(Object.assign({ prompt, response_format: isUrl ? 'url' : 'b64_json', model: 'dall-e-3' }, (isVertical ? { size: '1024x1792' } : {})))).data[0];
            return isUrl ? generate.url : generate.b64_json;
        });
    }
    generatePromptForPicture(prompt) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a;
            return (((_a = (yield openai.chat.completions.parse({
                model: 'gpt-4.1',
                messages: [
                    {
                        role: 'system',
    ...
    generatePosts(content) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return shuffle(posts.map((choice) => {
    ...
    extractWebsiteText(content) {
        return __awaiter(this, void 0, void 0, function* () {
            const websiteContent = yield openai.chat.completions.create({
                messages: [
                    {
                        role: 'assistant',
    ...
    separatePosts(content, len) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const posts = ((_a = (yield openai.chat.completions.parse({
                model: 'gpt-4.1',
                messages: [
                    {
                        role: 'system',
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (let i = 0; i < 3; i++) {
                try {
                    ...
                    const parse = ((_a = (yield openai.chat.completions.parse({
                        model: 'gpt-4.1',
                        messages: [
                            {
                                role: 'system',
