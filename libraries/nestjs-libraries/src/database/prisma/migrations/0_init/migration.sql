...
-- CreateEnum
CREATE TYPE "VocaccioRole" AS ENUM ('OWNER', 'OPERATOR', 'EDITOR', 'VIEWER_INTERNAL', 'CLIENT_USER');

-- CreateEnum
CREATE TYPE "ProjectStatus" AS ENUM ('ACTIVE', 'PAUSED', 'ARCHIVED');

-- CreateEnum
CREATE TYPE "ToneOfVoice" AS ENUM ('FORMAL', 'CASUAL', 'INSPIRATIONAL', 'TECHNICAL', 'PLAYFUL', 'AUTHORITATIVE');

-- CreateEnum
CREATE TYPE "ContentType" AS ENUM ('POST', 'CAROUSEL', 'VIDEO', 'STORY', 'REEL');

-- CreateEnum
CREATE TYPE "ContentStatus" AS ENUM ('DRAFT', 'PENDING_APPROVAL', 'APPROVED', 'ADJUSTMENT_REQUESTED', 'PUBLISHED', 'ARCHIVED');
...
CREATE TABLE "UserOrganization" (
    ...
    "vocaccioRole" "VocaccioRole" NOT NULL DEFAULT 'VIEWER_INTERNAL',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
CREATE TABLE "ReligareProfile" (
    ...
    CONSTRAINT "ReligareProfile_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "ClientExpert" (
    "id" TEXT NOT NULL,
    "clientId" TEXT NOT NULL,
    "expertId" TEXT NOT NULL,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,

    CONSTRAINT "ClientExpert_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "Project" (
    ...
    "persona" JSONB,
    "toneOfVoice" "ToneOfVoice" NOT NULL DEFAULT 'CASUAL',
    "website" TEXT,
    "bioLink" TEXT,
    "cta1" TEXT,
    "cta2" TEXT,
    "cta3" TEXT,
    "briefing" TEXT,
    "vocationalProfileId" TEXT,
    "locale" TEXT NOT NULL DEFAULT 'pt-BR',
    "timezone" TEXT NOT NULL DEFAULT 'America/Sao_Paulo',
    "status" "ProjectStatus" NOT NULL DEFAULT 'ACTIVE',
    "contextPackCache" JSONB,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
    "deletedAt" TIMESTAMP(3),
...
CREATE TABLE "AccessLinkEvent" (
    ...
    CONSTRAINT "AccessLinkEvent_pkey" PRIMARY KEY ("id")
);
...
-- CreateTable
CREATE TABLE "ContentItemEvent" (
    "id" TEXT NOT NULL,
    "itemId" TEXT NOT NULL,
    "type" TEXT NOT NULL,
    "text" TEXT,
    "byGuest" BOOLEAN NOT NULL DEFAULT false,
    "metadata" JSONB,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,

    CONSTRAINT "ContentItemEvent_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "UserOrganization_vocaccioRole_idx" ON "UserOrganization"("vocaccioRole");
...
-- CreateIndex
CREATE INDEX "Integration_crmClientId_idx" ON "Integration"("crmClientId");
...
-- CreateIndex
CREATE INDEX "Expert_orgId_idx" ON "Expert"("orgId");

-- CreateIndex
CREATE INDEX "Expert_deletedAt_idx" ON "Expert"("deletedAt");

-- CreateIndex
CREATE UNIQUE INDEX "ReligareProfile_expertId_key" ON "ReligareProfile"("expertId");

-- CreateIndex
CREATE UNIQUE INDEX "ReligareProfile_shareToken_key" ON "ReligareProfile"("shareToken");

-- CreateIndex
CREATE INDEX "ReligareProfile_orgId_idx" ON "ReligareProfile"("orgId");

-- CreateIndex
CREATE INDEX "ReligareProfile_deletedAt_idx" ON "ReligareProfile"("deletedAt");

-- CreateIndex
CREATE INDEX "ClientExpert_clientId_idx" ON "ClientExpert"("clientId");

-- CreateIndex
CREATE INDEX "ClientExpert_expertId_idx" ON "ClientExpert"("expertId");

-- CreateIndex
CREATE UNIQUE INDEX "ClientExpert_clientId_expertId_key" ON "ClientExpert"("clientId", "expertId");
...
-- CreateIndex
CREATE INDEX "ClientInteraction_createdAt_idx" ON "ClientInteraction"("createdAt");
...
-- CreateIndex
CREATE UNIQUE INDEX "ProjectAccessLink_tokenHash_key" ON "ProjectAccessLink"("tokenHash");

-- CreateIndex
CREATE INDEX "ProjectAccessLink_projectId_idx" ON "ProjectAccessLink"("projectId");

-- CreateIndex
CREATE INDEX "AccessLinkEvent_linkId_idx" ON "AccessLinkEvent"("linkId");

-- CreateIndex
CREATE INDEX "AccessLinkEvent_createdAt_idx" ON "AccessLinkEvent"("createdAt");

-- CreateIndex
CREATE INDEX "InternalTask_orgId_idx" ON "InternalTask"("orgId");

-- CreateIndex
CREATE INDEX "InternalTask_assigneeId_idx" ON "InternalTask"("assigneeId");
...
-- CreateIndex
CREATE INDEX "ContentItem_orgId_idx" ON "ContentItem"("orgId");
...
-- CreateIndex
CREATE INDEX "ContentItemEvent_itemId_idx" ON "ContentItemEvent"("itemId");

-- CreateIndex
CREATE INDEX "ContentItemEvent_createdAt_idx" ON "ContentItemEvent"("createdAt");
...
-- AddForeignKey
ALTER TABLE "Integration" ADD CONSTRAINT "Integration_crmClientId_fkey" FOREIGN KEY ("crmClientId") REFERENCES "Client"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Expert" ADD CONSTRAINT "Expert_orgId_fkey" FOREIGN KEY ("orgId") REFERENCES "Organization"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ReligareProfile" ADD CONSTRAINT "ReligareProfile_orgId_fkey" FOREIGN KEY ("orgId") REFERENCES "Organization"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ReligareProfile" ADD CONSTRAINT "ReligareProfile_expertId_fkey" FOREIGN KEY ("expertId") REFERENCES "Expert"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ClientExpert" ADD CONSTRAINT "ClientExpert_clientId_fkey" FOREIGN KEY ("clientId") REFERENCES "Client"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ClientExpert" ADD CONSTRAINT "ClientExpert_expertId_fkey" FOREIGN KEY ("expertId") REFERENCES "Expert"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "ProjectAccessLink" ADD CONSTRAINT "ProjectAccessLink_projectId_fkey" FOREIGN KEY ("projectId") REFERENCES "Project"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "AccessLinkEvent" ADD CONSTRAINT "AccessLinkEvent_linkId_fkey" FOREIGN KEY ("linkId") REFERENCES "ProjectAccessLink"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "ContentItemEvent" ADD CONSTRAINT "ContentItemEvent_itemId_fkey" FOREIGN KEY ("itemId") REFERENCES "ContentItem"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
