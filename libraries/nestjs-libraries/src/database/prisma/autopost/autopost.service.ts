...
import {
  ...
  createLangChainImageModel,
  getAiAutopostImageModel,
  getAiAutopostModel,
...
const model = createLangChainChatModel('autopost', getAiAutopostModel(), 0.7);

const dalle = createLangChainImageModel(getAiAutopostImageModel());
