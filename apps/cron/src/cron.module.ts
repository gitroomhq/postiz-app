...
@Module({
  ...
  controllers: [],
  providers: [...(!process.env.IS_GENERAL ? [CheckStars,SyncTrending] : [SocialTokenRefreshTask,GBPInsightsTask,InstagramInsightsTask,FacebookInsightsTask,XInsightsTask,WebsiteInsightsTask,LinkedInInsightsTask,YoutubeInsightsTask])],
})
