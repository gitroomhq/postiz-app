...
export default function PublicLayout({ children }: { children: ReactNode }) {
  return (
    <html lang="en">
      ...
      <body className={`${jakartaSans.className} dark text-white bg-[#0E0E0E] min-h-screen flex flex-col`}>
        {/* Header */}
        <header className="border-b border-[#252525]">
          <div className="max-w-[920px] mx-auto px-[24px] py-[20px] flex items-center justify-between">
            <Link href="/auth/login" className="flex items-center gap-[8px] select-none hover:opacity-90 transition-opacity">
              <span className="font-bold text-[22px] leading-none tracking-tight text-[#1D4ED8]">D3</span>
              <span className="font-bold text-[22px] leading-none tracking-tight text-white">Analytics</span>
            </Link>
