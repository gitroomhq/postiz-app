  ...
  return (
    <article>
      ...
      <p className={paragraph}>
        ...
        Union General Data Protection Regulation (&ldquo;<strong className="text-white">GDPR</strong>&rdquo;)
        and the Malaysian Personal Data Protection Act 2010 (&ldquo;<strong className="text-white">PDPA</strong>&rdquo;),
      ...
      <ul className="list-disc pl-[24px] mb-[12px]">
        <li className={bullet}>The OAuth access tokens issued by the platform (for OAuth-based
          integrations such as Meta and TikTok)</li>
        <li className={bullet}>Your public profile information on that platform (such as username,
          profile picture, follower count)</li>
        <li className={bullet}>Profile URLs you submit voluntarily (for Douyin and Xiaohongshu)</li>
        <li className={bullet}>Publicly visible posts, engagement metrics, and aggregate analytics
          data that you have authorized the platform to share with us</li>
      </ul>
      <p className={paragraph}>
      ...
      <ul className="list-disc pl-[24px] mb-[12px]">
        <li className={bullet}>Aggregated metrics about your connected accounts (followers, views,
          impressions, engagement rate, likes, comments, shares)</li>
        <li className={bullet}>Time-series snapshots of these metrics so we can show you growth charts</li>
        <li className={bullet}>Service usage information (pages visited, features used, session
          duration) collected through privacy-friendly analytics</li>
      </ul>
      ...
      <ul className="list-disc pl-[24px] mb-[12px]">
        ...
        <li className={bullet}>To respond to your support requests and communicate with you about
          your account or important service notices</li>
      ...
      <ul className="list-disc pl-[24px] mb-[12px]">
        <li className={bullet}>
          <strong className="text-white">Meta Platforms (Facebook & Instagram API)</strong> — used
          to fetch authorized analytics data from your Facebook and Instagram accounts via OAuth.
        </li>
        <li className={bullet}>
          <strong className="text-white">TikTok Developer API</strong> — used to fetch authorized
          analytics data from your TikTok account via OAuth.
        </li>
        <li className={bullet}>
          <strong className="text-white">Apify</strong> — used to fetch publicly available data
          from Douyin and Xiaohongshu (RedNote) profile URLs you submit. Only public data is
          accessed; private insights are not available for these platforms.
        </li>
        <li className={bullet}>
          <strong className="text-white">Supabase (PostgreSQL hosting)</strong> — used to securely
          store your account information and analytics data. Supabase&rsquo;s data centers operate
          in the region we select and follow industry-standard security practices.
        </li>
        <li className={bullet}>
          <strong className="text-white">Vercel</strong> — used to host the web application and
      ...
      <p className={paragraph}>
        Your personal data is stored in a PostgreSQL database hosted by Supabase. We implement
        appropriate technical and organisational safeguards to protect your information, including:
      </p>
      <ul className="list-disc pl-[24px] mb-[12px]">
      ...
      <p className={paragraph}>
        While we use commercially reasonable efforts to protect your data, no method of internet
      ...
      <p className={paragraph}>
        ...
        your account, we will delete or anonymise your personal information within ninety (90)
        days, except where we are required by law to retain it longer (for example, for tax or
        accounting purposes).
      </p>
      ...
      <ul className="list-disc pl-[24px] mb-[12px]">
        <li className={bullet}>
          <strong className="text-white">Right to access</strong> — you may request a copy of the
          personal data we hold about you.
        </li>
        <li className={bullet}>
          <strong className="text-white">Right to rectification</strong> — you may ask us to
          correct inaccurate or incomplete personal data.
        </li>
        <li className={bullet}>
          <strong className="text-white">Right to deletion (&ldquo;right to be forgotten&rdquo;)</strong>{' '}
          — you may request that we delete your personal data.
        </li>
        <li className={bullet}>
          <strong className="text-white">Right to data portability</strong> — you may request to
          receive your data in a structured, commonly used, machine-readable format.
        </li>
        <li className={bullet}>
          <strong className="text-white">Right to restrict or object to processing</strong> —
          you may request that we restrict or stop processing your data in certain circumstances.
        </li>
        <li className={bullet}>
          <strong className="text-white">Right to withdraw consent</strong> — where processing is
          based on your consent, you may withdraw it at any time.
        </li>
        <li className={bullet}>
          <strong className="text-white">Right to lodge a complaint</strong> — you may lodge a
          complaint with your local data protection authority (in Malaysia, the Personal Data
      ...
      <p className={paragraph}>
        ...
        example, in your Facebook, Instagram, or TikTok app permissions).
      </p>
      ...
      <ul className="list-disc pl-[24px] mb-[12px]">
        <li className={bullet}>
          <strong className="text-white">Strictly necessary cookies</strong> — required to keep you
          logged in and to remember your language and theme preferences. These cannot be disabled.
        </li>
        <li className={bullet}>
          <strong className="text-white">Analytics cookies</strong> — privacy-friendly analytics
          to understand how the Service is used in aggregate. No cross-site tracking is performed.
        </li>
      </ul>
      <p className={paragraph}>
        You can control cookies through your browser settings. Disabling strictly necessary cookies
        may prevent the Service from functioning correctly.
      </p>

      <h2 className={sectionTitle}>9. International Data Transfers</h2>
      <p className={paragraph}>
        Your information may be transferred to and processed in countries other than your country
        of residence, including the United States and the European Union, where our service
        providers operate. Where required, we rely on appropriate safeguards such as the European
        Commission&rsquo;s Standard Contractual Clauses to protect your personal data during these
        transfers.
      </p>
      ...
      <p className={paragraph}>
        ...
        data, please contact us and we will delete the information promptly.
      </p>
      ...
      <p className={paragraph}>
        ...
        provide a more prominent notice (for example, via email or an in-app notification). Your
      ...
      <div className="mt-[40px] pt-[20px] border-t border-[#252525]">
        <p className="text-[12px] text-[#696868] italic leading-[1.6]">
          ...
          legal professional before relying on this policy for production use.
        </p>
      </div>
    </article>
  );
