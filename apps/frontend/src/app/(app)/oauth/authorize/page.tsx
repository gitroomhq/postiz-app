        ...
        <div className="bg-[#1A1919] rounded-[16px] p-[32px] flex flex-col gap-[24px]">
          ...
          <div className="border-t border-[#2A2929] pt-[16px]">
            <div className="text-[14px] text-gray-400 mb-[12px]">
              This application is requesting access to your Postra account. It
              will be able to:
            </div>
          ...
          <div className="flex gap-[12px]">
            <button
              ...
              disabled={submitting}
              className="flex-1 bg-[#c15f3c] hover:bg-[#7B3FF2] disabled:opacity-50 text-white rounded-[8px] py-[10px] px-[16px] text-[14px] font-semibold transition-colors"
            >
              Authorize
            </button>
            <button
