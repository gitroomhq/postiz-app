                ...
                <div className="flex space-x-3">
                  <div>
                    <span className="flex shrink-0 overflow-hidden rounded-full h-30 w-30">
                      <img
                        className="relative z-[20] bg-black aspect-square h-full w-full rounded-full border-tableBorder"
                        alt="John Doe"
                    ...
                    <div className="flex space-x-4 pt-2">
                      <button className="inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 hover:bg-accent h-9 rounded-md px-3 text-gray-500 hover:text-blue-500">
                        <svg
                          ...
                          className="lucide lucide-message-circle mr-1 h-4 w-4"
                        >
                      ...
                      <button className="inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 hover:bg-accent h-9 rounded-md px-3 text-gray-500 hover:text-green-500">
                        <svg
                          ...
                          strokeLinecap="round"
                          strokeLinejoin="round"
                          className="lucide lucide-repeat2 mr-1 h-4 w-4"
                        >
                          <path d="m2 9 3-3 3 3" />
                      ...
                      <button className="inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 hover:bg-accent h-9 rounded-md px-3 text-gray-500 hover:text-red-500">
                        <svg
                          ...
                          strokeLinecap="round"
                          strokeLinejoin="round"
                          className="lucide lucide-heart mr-1 h-4 w-4"
                        >
