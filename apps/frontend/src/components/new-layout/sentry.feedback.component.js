...
export const AttachToFeedbackIcon = () => {
    ...
    useEffect(() => {
        ...
        if (!sentryDsn)
            return;
        try {
            const fb = (_b = (_a = Sentry).getFeedback) === null || _b === void 0 ? void 0 : _b.call(_a);
            setFeedback(fb);
        }
        catch (e) {
