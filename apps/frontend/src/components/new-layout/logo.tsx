...
export const Logo = () => (
  ...
  >
    ...
    <rect width="44" height="44" rx="11" fill="url(#voc-r1)" />
    <rect width="44" height="44" rx="11" fill="url(#voc-r2)" />
    <rect width="44" height="44" rx="11" fill="url(#voc-r3)" />
    <g transform={iconTransform(44, 11)}>
