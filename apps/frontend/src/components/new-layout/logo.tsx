...
export const Logo = () => {
  return (
    ...
    >
      ...
      {/* Símbolo original de Simbolo-Vocaccio.svg via nested viewBox — sem conversão manual */}
      <svg x="6" y="4" width="32" height="36" viewBox="0 0 128.25 143.249998" preserveAspectRatio="xMidYMid meet">
