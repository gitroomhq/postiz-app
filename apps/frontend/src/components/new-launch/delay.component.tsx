            ...
            {delayOptions.map((option) => (
              <div
                ...
                className={clsx(
                  ...
                  currentDelay === option.value && 'bg-[#c15f3c] text-white hover:bg-[#c15f3c]'
                )}
              >
                {option.label}
              </div>
          ...
          <div className="border-t border-newTextColor/10 mt-[8px] pt-[8px]">
            <div className="flex gap-[4px]">
              <input
                ...
                className={clsx(
                  'flex-1 w-full h-[32px] px-[8px] rounded-[4px] bg-newBgColor border text-[13px] outline-none focus:border-[#c15f3c]',
                  isCustomDelay ? 'border-[#c15f3c]' : 'border-newTextColor/10'
                )}
              />
              <button
                onClick={(e) => {
                ...
                className="h-[32px] px-[10px] rounded-[4px] bg-[#c15f3c] text-white text-[12px] font-[600] hover:bg-[#c15f3c]/80"
              >
                Set
              </button>
            </div>
