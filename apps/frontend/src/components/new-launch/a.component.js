'use client';
export const AComponent = ({ editor }) => {
    const mark = () => {
        var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k;
        const previousUrl = (_a = editor === null || editor === void 0 ? void 0 : editor.getAttributes('link')) === null || _a === void 0 ? void 0 : _a.href;
        ...
        // empty
        if (url === '') {
            (_e = (_d = (_c = (_b = editor === null || editor === void 0 ? void 0 : editor.chain()) === null || _b === void 0 ? void 0 : _b.focus()) === null || _c === void 0 ? void 0 : _c.extendMarkRange('link')) === null || _d === void 0 ? void 0 : _d.unsetLink()) === null || _e === void 0 ? void 0 : _e.run();
            return;
        }
        // update link
        try {
            (_j = (_h = (_g = (_f = editor === null || editor === void 0 ? void 0 : editor.chain()) === null || _f === void 0 ? void 0 : _f.focus()) === null || _g === void 0 ? void 0 : _g.extendMarkRange('link')) === null || _h === void 0 ? void 0 : _h.setLink({ href: url })) === null || _j === void 0 ? void 0 : _j.run();
        }
        catch (e) { }
        (_k = editor === null || editor === void 0 ? void 0 : editor.commands) === null || _k === void 0 ? void 0 : _k.focus();
    };
    return (<div data-tooltip-id="tooltip" data-tooltip-content="Link" onClick={mark} className="select-none cursor-pointer rounded-[6px] w-[30px] h-[30px] bg-newColColor flex justify-center items-center">
