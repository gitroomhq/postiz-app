        ...
        >
          <div
            ...
            className={clsx(
              ...
              current !== 'global'
                ? 'text-[#A3A3A3]'
                : 'border border-[var(--new-table-text-focused)] text-[var(--new-table-text-focused)]'
            )}
          >
            <div>
              <GlobalIcon />
            ...
            <div
              ...
              className={clsx(
                ...
                current === integration.id
                  ? 'border-[var(--new-table-text-focused)] text-[var(--new-table-text-focused)]'
                  : 'border-transparent'
              )}
            >
              <div
...
export const IsGlobal: FC<{ id: string }> = ({ id }) => {
  ...
  return (
    <div
      ...
      className="w-[8px] h-[8px] bg-[var(--new-table-text-focused)] -top-[1px] -end-[3px] absolute rounded-full"
    />
  );
};
