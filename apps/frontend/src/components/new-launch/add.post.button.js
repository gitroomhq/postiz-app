...
export const AddPostButton = (props) => {
    ...
    return (<div className="flex">
      <div onClick={onClick} className="select-none cursor-pointer h-[34px] rounded-[6px] flex bg-[#D82D7E] gap-[8px] justify-center items-center pl-[16px] pr-[20px] text-[13px] font-[600] mt-[12px]">
        <div>
        ...
        <div className="!text-white">
          {t(...(props.postComment === PostComment.ALL
...
//# sourceMappingURL=add.post.button.js.map