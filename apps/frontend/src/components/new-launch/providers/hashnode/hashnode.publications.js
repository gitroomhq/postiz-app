...
export const HashnodePublications = (props) => {
    ...
    return (<Select name={name} label="Select publication" onChange={onChangeInner} value={currentMedia}>
...
//# sourceMappingURL=hashnode.publications.js.map