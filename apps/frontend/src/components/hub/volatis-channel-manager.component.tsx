...
const ChannelRow = ({
  ...
  return (
    <div
      ...
      style={{ borderBottom: '1px solid var(--voc-line)' }}
    >
      <img
      ...
      />
      <span
        className="text-[13px] font-[600] flex-1 truncate"
      ...
      <select
        ...
        className="text-[12px] px-[8px] py-[5px] rounded-[8px] outline-none cursor-pointer"
        style={{
  ...
  return (
    <div className="relative">
      <button
        type="button"
        onClick={() => setOpen((v) => !v)}
        className="flex items-center gap-[6px] px-[12px] h-[36px] rounded-[10px] text-[12px] font-[600] transition-colors"
        style={{
          background: open ? 'rgba(115,96,170,0.12)' : 'var(--voc-paper-raised)',
          color: open ? 'var(--voc-violet)' : 'var(--voc-ink-soft)',
          border: '1px solid var(--voc-line)',
        }}
      >
        <Settings2 size={13} />
      ...
      {open && (
        <div
          className="absolute top-[42px] right-0 z-50 w-[380px] rounded-[14px] flex flex-col overflow-hidden"
          style={{
        ...
        >
          <div
            className="px-[16px] py-[10px] text-[11px] font-[700] uppercase tracking-[0.1em]"
            style={{
          ...
          {!integrations?.length ? (
            <div className="px-[16px] py-[20px] text-[13px]" style={{ color: 'var(--voc-ink-soft)' }}>
