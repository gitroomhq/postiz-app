...
export const StreakComponent = () => {
    ...
    const streakDays = useMemo(() => {
        if (!(user === null || user === void 0 ? void 0 : user.streakSince))
            return 0;
        ...
        return diffDays + 1;
    }, [user === null || user === void 0 ? void 0 : user.streakSince]);
