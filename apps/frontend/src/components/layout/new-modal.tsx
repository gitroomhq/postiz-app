      ...
      <div
        ...
        className={clsx(
          !modal.fullScreen
            ...
            : 'w-full h-full',
          'fixed flex left-0 top-0 bg-popup animate-fadeIn overflow-y-auto text-newTextColor',
  ...
  return (
    <CurrentModalContext.Provider value={{ id: modal.id }}>
      <div
        ...
        style={{ zIndex }}
        className={clsx(
          'fixed flex left-0 top-0 min-w-full min-h-full bg-popup animate-fadeIn overflow-y-auto text-newTextColor',
