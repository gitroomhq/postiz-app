...
export const OrganizationSelector = ({ asOpenSelect, }) => {
    const fetch = useFetch();
    const user = useUser();
    const load = useCallback(() => __awaiter(void 0, void 0, void 0, function* () {
        return yield (yield fetch('/user/organizations')).json();
    }), []);
    ...
    const current = useMemo(() => {
        return data === null || data === void 0 ? void 0 : data.find((d) => d.id === (user === null || user === void 0 ? void 0 : user.orgId));
    }, [data]);
    const withoutCurrent = useMemo(() => {
        return data === null || data === void 0 ? void 0 : data.filter((d) => d.id !== (user === null || user === void 0 ? void 0 : user.orgId));
    }, [current, data]);
    const changeOrg = useCallback((org) => () => __awaiter(void 0, void 0, void 0, function* () {
        yield fetch('/user/change-org', {
            method: 'POST',
            body: JSON.stringify({
                id: org.id,
            }),
