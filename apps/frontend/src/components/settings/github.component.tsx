...
const ConnectedComponent: FC<{
  ...
  return (
    <div className="my-[16px] mt-[16px] h-[90px] rounded-pqMd bg-pqPop shadow-[inset_0_0_0_1px_var(--border)] p-[24px]">
...
const ConnectComponent: FC<{
  ...
  return (
    <div className="my-[16px] mt-[16px] h-[100px] rounded-pqMd bg-pqPop shadow-[inset_0_0_0_1px_var(--border)] px-[24px] flex">
