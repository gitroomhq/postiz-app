...
const useFaqList = () => {
  ...
  return [
    ...(user?.allowTrial
      ? [
          {
            title: 'Am I going to be charged by Publica?',
            description:
              'To confirm credit card information Publica will hold $2 and release it immediately',
          },
        ]
      : []),
    // {
    //   title: `Can I trust ${isGeneral ? 'Publica' : 'Gitroom'}?`,
    //   description: `${
    //     isGeneral ? 'Publica' : 'Gitroom'
    //   } is proudly open-source! We believe in an ethical and transparent culture, meaning that ${
    //     isGeneral ? 'Publica' : 'Gitroom'
    //   } will live forever. You can check out the entire code or use it for personal projects. To view the open-source repository, <a href="https://github.com/Padilla-core/publica-app" target="_blank" style="text-decoration: underline;">click here</a>.`,
    // },
    {
