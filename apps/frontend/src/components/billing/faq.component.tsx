  ...
  return [
      ...
      : []),
    {
      ...
      description: t(
        ...
        'Postra is proudly open-source! We believe in an ethical and transparent culture, meaning that Postra will live forever. You can check out the entire code or use it for personal projects. To view the open-source repository, <a href="https://github.com/KrisRz/postiz-app" target="_blank" style="text-decoration: underline;">click here</a>.'
      ),
    },
    {
