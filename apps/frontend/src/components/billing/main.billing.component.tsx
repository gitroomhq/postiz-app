  ...
  return (
    <div>
      ...
      <div className="flex gap-[10px]">
        ...
        <Button onClick={() => resolve(false)} className="!bg-transparent !text-lamboAsh underline uppercase !text-[12px]">
  ...
  return (
    <div className="flex flex-col gap-[16px]">
      <div className="flex flex-row">
        <div className="flex-1 text-[20px] font-lambo uppercase tracking-tight">{t('plans', 'Plans')}</div>
        <div className="flex items-center gap-[16px] uppercase tracking-[0.14px]">
        ...
        {Object.entries(pricing)
          ...
          .map(([name, values]) => (
            <div
              key={name}
              className={clsx(
                'flex-1 bg-lamboCharcoal p-[24px] gap-[16px] flex flex-col [@media(max-width:1024px)]:items-center',
                currentPackage === name.toUpperCase()
                  ? 'border-2 border-lamboGold'
                  : ''
              )}
            >
              <div className="text-[24px] font-lambo uppercase tracking-tight">{name}</div>
              <div className="text-[54px] leading-[1.19] flex gap-[2px] items-center font-lambo text-lamboGold">
                <div>
                  $
                  {monthlyOrYearly === 'on'
                    ? values.year_price
                ...
                <div className={`text-[14px] text-lamboAsh uppercase tracking-[0.14px]`}>
                ...
                subscription?.cancelAt ? (
                  ...
                  <Button
                    ...
                    className={clsx(
                      subscription &&
                        name.toUpperCase() === 'FREE' &&
                        '!bg-transparent !text-lamboAsh underline uppercase !text-[12px]'
                    )}
      ...
      {!!subscription?.id && (
        <div className="flex justify-center mt-[20px] gap-[10px]">
          ...
          {isGeneral && !subscription?.cancelAt && (
            <Button
              className="!bg-transparent !text-lamboAsh underline uppercase !text-[12px]"
              loading={loading}
