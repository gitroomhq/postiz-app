...
export const FinishTrial = (props) => {
    const [finished, setFinished] = useState(false);
    const fetch = useFetch();
    const finishSubscription = useCallback(() => __awaiter(void 0, void 0, void 0, function* () {
        yield fetch('/billing/finish-trial', {
            method: 'POST',
        });
        checkFinished();
    }), []);
    const checkFinished = useCallback(() => __awaiter(void 0, void 0, void 0, function* () {
        const { finished } = yield (yield fetch('/billing/is-trial-finished')).json();
        if (!finished) {
            yield timer(2000);
    ...
    return (<div className="text-textColor fixed start-0 top-0 bg-primary/80 z-[300] w-full h-full p-[60px] animate-fade justify-center flex bg-black/50">
      <div>
          ...
          <div className="relative h-[400px]">
            <div className="absolute left-0 top-0 w-full h-full overflow-hidden overflow-y-auto">
              <div className="mt-[10px] flex w-full justify-center items-center gap-[10px]">
                ...
                {finished && (<div className="flex flex-col">
                    <div>
...
//# sourceMappingURL=finish.trial.js.map