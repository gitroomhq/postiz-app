...
export const GoogleProvider = () => {
    ...
    const gotoLogin = useCallback(() => __awaiter(void 0, void 0, void 0, function* () {
        const link = yield (yield fetch('/auth/oauth/GOOGLE')).text();
        window.location.href = link;
    }), []);
    return (<div onClick={gotoLogin} className={`cursor-pointer flex-1 bg-white h-[52px] rounded-[10px] flex justify-center items-center text-[#0E0E0E] gap-[10px]`}>
      <div>
