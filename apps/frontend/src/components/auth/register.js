...
import { WalletUiProvider } from "./providers/placeholder/wallet.ui.provider";
...
export function Register() {
    ...
    const [provider] = useState((_a = getQuery === null || getQuery === void 0 ? void 0 : getQuery.get('provider')) === null || _a === void 0 ? void 0 : _a.toUpperCase());
    const [code, setCode] = useState((getQuery === null || getQuery === void 0 ? void 0 : getQuery.get('code')) || '');
    ...
    const load = useCallback(() => __awaiter(this, void 0, void 0, function* () {
        const { token } = yield (yield fetch(`/auth/oauth/${(provider === null || provider === void 0 ? void 0 : provider.toUpperCase()) || 'LOCAL'}/exists`, {
            method: 'POST',
            body: JSON.stringify({
                code,
            }),
    ...
    return (<RegisterAfter token={code} provider={(provider === null || provider === void 0 ? void 0 : provider.toUpperCase()) || 'LOCAL'}/>);
}
...
export function RegisterAfter({ token, provider, }) {
    const t = useT();
    ...
    const onSubmit = (data) => __awaiter(this, void 0, void 0, function* () {
        setLoading(true);
        yield fetchData('/auth/register', {
            method: 'POST',
            body: JSON.stringify(Object.assign(Object.assign({}, data), { datafast_visitor_id })),
        })
      ...
      <form className="flex-1 flex" onSubmit={form.handleSubmit(onSubmit)}>
        <div className="flex flex-col flex-1">
          ...
          <div className="flex flex-col">
            {!isAfterProvider &&
            (!isGeneral ? (<GithubProvider />) : (<div className="gap-[8px] flex">
                  {genericOauth && isGeneral ? (<OauthProvider />) : (<GoogleProvider />)}
                  {!!neynarClientId && <FarcasterProvider />}
                  {billingEnabled && <WalletProvider />}
                </div>))}
            {!isAfterProvider && (<div className="h-[20px] mb-[24px] mt-[24px] relative">
            ...
            <div className="flex flex-col gap-[12px]">
              <div className="text-textColor">
                ...
                <Input label="Company" translationKey="label_company" {...form.register('company')} autoComplete="off" type="text" placeholder={t('label_company', 'Company')}/>
              </div>
