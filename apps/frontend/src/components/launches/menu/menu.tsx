...
export const Menu: FC<{
  ...
  const menuItemClass =
    'group flex gap-[12px] items-center rounded-[12px] border border-transparent py-[10px] px-[12px] text-textColor/78 transition-all duration-200 hover:border-white/8 hover:bg-white/6 hover:text-textColor';
  const iconClass =
    ...
    >
      ...
      {show && (
        <div
          ...
          className="fixed z-[100] flex min-w-[250px] flex-col gap-[8px] rounded-[18px] border border-white/10 bg-[linear-gradient(180deg,rgba(15,23,42,0.92),rgba(10,14,26,0.98))] p-[12px] text-nowrap shadow-[0_28px_80px_rgba(2,6,23,0.45)] backdrop-blur-2xl"
        >
          ...
          >
            ...
            <div className="text-[14px] font-[500]">{t('copy_id', 'Copy Channel ID')}</div>
          </div>
          {canDisable &&
          ...
          {canDisable && (
            <div
              className={`${menuItemClass} hover:border-[#fb7185]/30 hover:bg-[rgba(251,113,133,0.08)] hover:text-[#fecdd3]`}
              onClick={disableChannel}
            >
              <div className={`${iconClass} group-hover:border-[#fb7185]/30 group-hover:bg-[rgba(251,113,133,0.08)] group-hover:text-[#fb7185]`}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height="16"
