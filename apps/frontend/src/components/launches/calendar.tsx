...
const CalendarItem: FC<{
  ...
  const user = useUser();
  const canManagePost = user?.role !== 'USER';
  ...
  return (
    <div
      ...
      className={clsx(
        ...
        approvalStatus === 'PENDING_APPROVAL' && 'rounded-[10px] ring-2 ring-yellow-500',
        approvalStatus === 'REJECTED' && 'rounded-[10px] ring-2 ring-red-300'
      )}
      style={{
        opacity,
      }}
