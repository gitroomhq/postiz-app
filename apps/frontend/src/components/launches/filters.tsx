...
export const Filters = () => {
  ...
  return (
    <div className="text-textColor flex flex-wrap gap-[8px] items-center select-none min-w-0">
      {!isListView && (
        <div className="flex flex-grow flex-wrap flex-row items-center gap-[8px] min-w-0">
          <div className="border h-[42px] border-newTableBorder bg-newTableBorder gap-[1px] flex items-center rounded-[8px] overflow-hidden min-w-0 max-w-full">
            <div
              onClick={previous}
              className="cursor-pointer text-textColor rtl:rotate-180 px-[9px] bg-newBgColorInner h-full flex shrink-0 items-center justify-center hover:text-textItemFocused hover:bg-boxFocused"
            >
              <svg
            ...
            <div className="min-w-0 sm:min-w-[200px] text-center bg-newBgColorInner h-full flex items-center justify-center">
              <div className="py-[3px] px-[9px] rounded-[5px] transition-all text-[14px] truncate max-w-[190px] sm:max-w-none">
                {getDisplayText()}
              </div>
            </div>
            <div
        ...
        <div className="flex flex-grow flex-wrap flex-row items-center gap-[8px] min-w-0">
          <div className="border h-[42px] border-newTableBorder bg-newTableBorder gap-[1px] flex items-center rounded-[8px] overflow-hidden min-w-0 max-w-full">
            <div
              ...
              className={clsx(
                'text-textColor rtl:rotate-180 px-[9px] bg-newBgColorInner h-full flex shrink-0 items-center justify-center',
                calendar.listPage > 0
          ...
          <div className="flex flex-row flex-wrap p-[4px] border border-newTableBorder rounded-[8px] text-[14px] font-[500]">
            {listStateOptions.map((option) => (
              <div
                ...
                className={clsx(
                  'pt-[6px] pb-[5px] cursor-pointer min-w-[72px] sm:min-w-[80px] px-[10px] sm:px-[12px] text-center rounded-[6px]',
      ...
      {!isListView && (
        <div className="flex flex-row p-[4px] border border-newTableBorder rounded-[8px] text-[14px] font-[500]">
          <div
            className={clsx(
              'pt-[6px] pb-[5px] cursor-pointer w-[64px] sm:w-[74px] text-center rounded-[6px]',
