  ...
  return (
    <div className="w-full flex flex-col gap-[20px] rounded-[4px] relative]">
      <div className="flex flex-col">
        <div className={clsx("grid grid-cols-2 xs:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-[10px] justify-items-center justify-center", onboarding ? 'grid-cols-9' : 'grid-cols-5')}>
          {social.map((item) => (
            <div
              key={item.identifier}
              ...
              {...(!!item.toolTip
                ...
                : {})}
              className={
                'w-full min-h-[110px] text-[14px] p-[10px] rounded-[8px] bg-newTableHeader text-textColor relative justify-center items-center flex flex-col gap-[10px] cursor-pointer'
              }
            >
              <div>
              ...
              <div className="whitespace-pre-wrap text-center">
                ...
                {!!item.toolTip && (
                  <svg
                    ...
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
                    className="absolute top-[5px] end-[5px]"
                  >
                    <path
