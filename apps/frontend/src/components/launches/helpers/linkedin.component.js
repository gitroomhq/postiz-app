...
import { TopTitle } from "./top.title.component";
...
export const ShowLinkedinCompany = () => {
    ...
    return (<LinkedinCompany id={id} onClose={close} onSelect={callback === null || callback === void 0 ? void 0 : callback.callback}/>);
};
export const LinkedinCompanyPop = (props) => {
...
export const LinkedinCompany = (props) => {
    ...
    const getCompany = () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            const { options } = yield (yield fetch('/integrations/function', {
                method: 'POST',
                body: JSON.stringify({
                    id,
                    name: 'company',
    ...
    return (<div className="text-textColor fixed start-0 top-0 bg-primary/80 z-[300] w-full h-full p-[60px] animate-fade justify-center flex">
      <div className="flex flex-col w-[500px] h-[250px] bg-sixth border-tableBorder border-2 rounded-xl pb-[20px] px-[20px] relative">
        <div className="flex">
          ...
          <button onClick={onClose} className="outline-none absolute end-[20px] top-[20px] mantine-UnstyledButton-root mantine-ActionIcon-root bg-primary hover:bg-tableBorder cursor-pointer mantine-Modal-close mantine-1dcetaa" type="button">
        ...
        <div className="mt-[10px]">
          <Input name="url" disableForm={true} label="URL" value={company} onChange={(e) => setCompany(e.target.value)} placeholder="https://www.linkedin.com/company/gitroom"/>
